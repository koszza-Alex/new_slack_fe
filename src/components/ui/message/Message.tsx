...
const EmojiPicker = dynamic(() => import("../emoji-picker/EmojiPicker"), {
  ssr: false,
});
    ...
    >
      ...
      {state !== "search" && showToolbar && (
        <div className="absolute right-4 top-[-20px] flex items-center bg-white border border-gray-200 rounded-xl shadow-sm px-2 py-1 z-11">
          <img
            src="/emoticons/tick.png"
            className="p-1 rounded-md hover:bg-gray-100"
          />
          <img
            src="/emoticons/eye.png"
            className="p-1 rounded-md hover:bg-gray-100"
          />
          <img
            src="/emoticons/welcome.png"
            className="p-1 rounded-md hover:bg-gray-100"
          />
              ...
              <div>
                <div className="flex items-center gap-2 text-sm text-gray-400 mt-2">
                  ...
                  <span
                    ...
                    onMouseOver={() =>
                      setDownloadTxt(
                        `${files.length} files available to download`,
                      )
                    }
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ease-in-out ${showFiles
